...
thématiques (niches), chacun vendant un produit interactif, sans intervention
manuelle et sans que l'ordinateur de l'utilisatrice soit allumé. Terminologie
fixée le 2026-09-12, à reprendre partout (templates, légendes, fiche Payhip,
guides), affinée le 2026-09-14 par niche : **« ebook interactif »** pour les
niches de langues (arabe, japonais, coréen), **« cahier d'exercices »** pour
les niches scientifiques (maths-prepa, physique-prepa), même si techniquement
c'est aussi un ebook, le terme doit coller au contenu réel vendu. Jamais
« PDF » dans les deux cas.
...
| `"html-katex"` | `generer_maths.py`, Chromium + KaTeX, 1080×1350, jusqu'à 8 slides | maths-prepa |
...
- Images à une **URL publique** : l'API Meta les télécharge, on ne peut pas
  ...
  **nouveau stockage** pour une niche langue (2 slides par post) et ~45 Mo/mois
  pour une niche scientifique (8 slides par post). Les images ne sont **jamais supprimées** de Cloudinary, donc ce
...
├── generer_maths.py            rendu Chromium + KaTeX, 1080×1350, 8 slides
